...
/**
 * Ubicación y medidas compartidas del taller de electrónica, a la izquierda de la cabina telefónica (sobre el
 * ensanche de la isla), mirando a la cámara de la vista general. Las piezas del taller se construyen en su
 * espacio local (origen en el centro del piso, +z hacia la calle, +x a la derecha de quien mira desde afuera)
 * y se colocan todas con la misma transformación. También fija dónde van el osciloscopio y la placa del PID
 * (en el banco, bajo el estante de la fuente).
 */
export class WorkshopLayout {
  public static readonly SHOP = { width: 2.6, depth: 2, height: 2.45, wall: 0.06, floor: 0.06 };

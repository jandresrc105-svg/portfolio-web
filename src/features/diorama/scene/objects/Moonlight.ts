...
/**
 * Ambiente nocturno: niebla del color del horizonte, luz de cielo y luna fría que recorta las siluetas.
...
export class Moonlight extends SceneObject {
  ...
  protected override build(): void {
    ...
    this.scene.fog = new FogExp2(Moonlight.HAZE, Moonlight.FOG_DENSITY);
